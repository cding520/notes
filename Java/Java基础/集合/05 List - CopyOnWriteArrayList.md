...
> CopyOnWriteArrayList是ArrayList的**线程安全**版本，内部也是通过数组实现，每次对数组的修改都完全拷贝一份新的数组来修改，修改完了再替换掉老数组，这样保证了**只阻塞写操作，不阻塞读操作**，实现读写分离。

## 二、继承体系

![image-20201115152020070](https://gitee.com/icecandy/imgbed/raw/master/Java/基础/20201115152021.png)
