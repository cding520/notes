...
>
> 它是**非线程安全的，且不保证元素存储的顺序；**

## 二、继承体系

![image-20201115165821844](https://gitee.com/icecandy/imgbed/raw/master/Java/基础/20201115165823.png)
...
![image-20201115190559094](https://gitee.com/icecandy/imgbed/raw/master/Java/基础/20201115190600.png)
...
- 数组的查询效率为O(1)，链表的查询效率是O(n)，红黑树的查询效率是O(log n)，n为桶中的元素个数，所以当元素数量非常多的时候，转化为红黑树能极大地提高效率。
...
>
> 参考：https://en.wikipedia.org/wiki/Poisson_distribution

### 4.2、内部类

#### 4.2.1、Node内部类

Node是一个典型的**单链表节点**，其中，hash用来存储key计算得来的hash值。
...
#### 4.3.2、HashMap(int initialCapacity)构造方法
...
#### 4.3.3、HashMap(int initialCapacity, float loadFactor)构造方法
...
#### 4.4.7、TreeNode.getTreeNode(int h, Object k)方法
...
#### 4.4.9、TreeNode.removeTreeNode(...)方法
